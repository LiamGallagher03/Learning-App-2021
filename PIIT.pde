...
Ion[] ions = new Ion[32];
int screen = 0, ionIndex, randomIon = (int) random(31);
...
public void theQuiz() {
  ...
  rectWindow var = new rectWindow(50, 12, "What is the name for this formula?: "+tempIon.formula);
  var.draw();
}

public void theAnswer() {
  Ion tempIon = ions[randomIon];
  rectWindow var = new rectWindow(50, 26, tempIon.name);
  var.draw();
}
